...
EditKindPage.propTypes = {};

function EditKindPage(props) {
  ...
  useEffect(() => {
    (async () => {
      const data = await kindsApi.getBySlug(slug);
  ...
  const handleOnSubmit = async (data) => {
    ...
    try {
      ...
      await kindsApi.update(state?.id, formdata);
      toast("Edit Kind Successfully");
